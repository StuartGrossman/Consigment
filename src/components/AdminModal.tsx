                ...
                <div className="max-w-2xl mx-auto">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-12 py-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 shadow-sm"
                    />
                    {searchQuery && (
                      <button
                  ...
                  {searchQuery && (
                    <div className="mt-3 text-center">
                      <p className="text-sm text-gray-600">
                        Found <span className="font-medium">{filteredItems.length}</span> of {pendingItems.length} items
                      </p>
                      <button
                        onClick={() => setSearchQuery('')}
